"""Stage 2 Test: Validates item totals after loading transactions1.json and transactions2.json"""

import sys
from results import transactions_2_expected
...
def test_stage2():
  """Test store dollar totals, item totals, and total items after loading 2 transaction files"""
  
  # Load both transaction files
  add_transaction_data("./data/transactions1.json")
  add_transaction_data("./data/transactions2.json")
  
  passed = True
  
  print("=" * 60)
  print("Stage 2 Test: Dollar and Item Totals")
  print("=" * 60)
  
  # Test store dollar totals
  print("\n--- Store Dollar Totals ---")
  actual_store_dollars = get_store_dollar_totals()
  expected_store_dollars = transactions_2_expected["store_dollars"]
  ...
  # Test store item totals
  print("\n--- Store Item Totals ---")
  actual_store_items = get_store_item_totals()
  expected_store_items = transactions_2_expected["store_items"]
  ...
  expected_total = transactions_2_expected["total_items"]
